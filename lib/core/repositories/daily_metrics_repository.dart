...
class DailyMetricsRepositoryImpl implements DailyMetricsRepository {
  ...
  DailyMetrics _rowToDomain(db.DailyMetric r) => DailyMetrics(
        ...
        rrIrregularityPct: r.rrIrregularityPct,
        ectopicBeatPct: r.ectopicBeatPct,
        rrEntropyNorm: r.rrEntropyNorm,
  ...
  db.DailyMetricsCompanion _toCompanion(DailyMetrics m) =>
      db.DailyMetricsCompanion.insert(
        ...
        rrIrregularityPct: Value(m.rrIrregularityPct),
        ectopicBeatPct: Value(m.ectopicBeatPct),
        rrEntropyNorm: Value(m.rrEntropyNorm),
